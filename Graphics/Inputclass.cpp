...
float InputClass::pos_x()
{
	return m_mouseState.lX;
}

float InputClass::pos_z()
{
	return m_mouseState.lY;
}

bool InputClass::IsFkeyPressed() // 20200618
{
	if (m_keyboardState[DIK_F] & 0x80)
	{
		return true;
