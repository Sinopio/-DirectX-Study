...
bool SkyDomeClass::Initialize(ID3D11Device* device)
{
	...
	result = LoadSkyDomeModel((char *)"../Graphics/data/skydome.txt");
	if (!result)
	{
		return false;
	}
	...
	m_apexColor = D3DXVECTOR4(0.4f, 0.9f, 0.9f, 1.0f);

	// Set the color at the center of the sky dome.
	m_centerColor = D3DXVECTOR4(0.4f, 0.9f, 0.9f, 1.0f);
...
void SkyDomeClass::change_Night()
{
	// Set the color at the top of the sky dome.
	m_apexColor = D3DXVECTOR4(0.4f, 0.9f, 0.9f, 1.0f);
...
void SkyDomeClass::change_Day()
{
	// Set the color at the top of the sky dome.
	m_apexColor = D3DXVECTOR4(0.1f, 0.1f, 0.1f, 1.0f);

	// Set the color at the center of the sky dome.
	m_centerColor = D3DXVECTOR4(0.1f, 0.1f, 0.1f, 1.0f);
}